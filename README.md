...
> ⚠️ Please note, some features aren't supported before Google Chrome v84, like partial keyframes, composite mode etc. Read the [article](https://web.dev/web-animations) to learn more.
